function prestim_analysis(sid, session)
% PRESTIM_ANALYSIS - compute absolute gamma power (40 Hz) over the
% pre-stimulus epoch.
%
...
% save
save(fullfile(savdir, 'prestim'), 'data');
